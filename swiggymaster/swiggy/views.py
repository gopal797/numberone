...
def admin_home(request):
    return render(request, "swiggy/admin_home.html")
...
def open_state(request):
    return render(request,'swiggy/open_state.html',{"sf":StateForm(),"sdata":StateModel.objects.all()})
...
def save_state(request):
    ...
    if sf.is_valid():
        ...
        return render(request,"swiggy/open_state.html",{"sf":sf})
...
def open_city(request):
    return render(request,'swiggy/open_city.html',{"sf":CityForm(),"sdata":CityModel.objects.all()})
...
def save_city(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "swiggy/open_city.html", {"sf": sf})
...
def open_area(request):
    return render(request, 'swiggy/open_area.html', {"sf": AreaForm(), "sdata": AreaModel.objects.all()})
...
def save_area(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "swiggy/open_area.html", {"sf": sf})


def open_type(request):
    return render(request, 'swiggy/open_type.html', {"sf": RestaurantTypeForm(), "sdata": RestaurantTypeModel.objects.all()})
...
def save_type(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "swiggy/open_type.html", {"sf": sf})
